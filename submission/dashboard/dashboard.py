from partikulasi_polusi import load_data, page_partilukalasi_polusi_harian, page_partilukalasi_polusi_mingguan, page_partilukalasi_polusi_bulanan, page_partilukalasi_polusi_tahunan
